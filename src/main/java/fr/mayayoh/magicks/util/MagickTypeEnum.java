...
public enum MagickTypeEnum {
    ...
    /**
     * Get the Magick Type associated with the name.
     *
     * @param name The name of the Magick type.
     * @return The Magick type.
     */
    public MagickTypeEnum getByName(final String name) {
        for (MagickTypeEnum t : MagickTypeEnum.values()) {
            if (t.name().equals(ChatColor.stripColor(name.toUpperCase(Locale.ROOT)))) {
                return t;
            }
        }
        return null;
